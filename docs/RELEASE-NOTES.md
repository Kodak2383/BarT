...
- macOS 26. BarT reads the menu bar through private CoreGraphics calls that are pinned to how that
  version behaves, and a major system update can break it.
...
- Items macOS pins itself, the clock and Control Center among them, cannot be dragged at all.
- Main screen only.
